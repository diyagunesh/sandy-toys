   ...
   data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
        ...
        <span class="icon-bar"></span>
			...
			url - http://localhost:8080/project1frontend/resources/images/niit.jpg
			 -->
				<a class="navbar-brand" href=""><img src='<c:url value="/resources/images/logo.jpg"></c:url>' alt="Sandy Toys" height="30px" width="90px"></a>
			</div>
			...
			<li><a href="<c:url value='/cart/purchasedetails'></c:url>">Cart</a></li>
			</security:authorize>
			...
			<ul>				
			<li class="dropdown">
			<a href="" class="dropdown-toggle" data-toggle="dropdown">Select by Category</a>
			<ul class="dropdown-menu">
					<li >
					<!-- Request parameter
					parameter name is 'searchCondition' -->
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Soft toys"></c:url>'>Soft toys</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Furry toys"></c:url>'>Furry toys</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Ghost toys"></c:url>'>Ghost toys</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Fibre toys"></c:url>'>Fibre toys</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Plastic toys"></c:url>'>Plastic toys</a>					   
